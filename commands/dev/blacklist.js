            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:Check:1265733979085078610> | **<@${user.id}> (${user.id})** has been added as a **Blacklist** user.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:Check:1265733979085078610> | **<@${user.id}> (${user.id})** has been removed from a **Blacklist** user.`
                        )
                ]
            })
        }
