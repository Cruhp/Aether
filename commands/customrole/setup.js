        ...
        if (input === 'add') {
            ...
            if (data) {
                if (data.names.length > 50) {
                    const embed = new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:Cross:1265733965180960849> | Sorry, you've reached the limit of **50** custom role setups. Please remove some setups to add new ones.`
                        )
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:Cross:1265733965180960849> | ${message.guild.prefix}setup add <name> <role>`
                            )
                    ]
                })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:Cross:1265733965180960849> | **Custom role** names cannot contain **mentions**. Please provide a different **name**.`
                            )
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:Cross:1265733965180960849> | ${message.guild.prefix}setup add ${args[1]} <role>`
                            )
                    ]
                })
            const role =
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:Cross:1265733965180960849> | Role **not** found!`
                            )
                    ]
                })
            if (role.managed)
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:Cross:1265733965180960849> | <@&${role.id}> isn't a **server** role!`
                            )
                    ]
                })
            let array = [
            ...
            if (
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setDescription(
                                `<a:Cross:1265733965180960849> | I can't **add** <@&${role.id}> in my **custom role** list because it has ${new Permissions(
            ...
            if (!data.names.length) {
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(
                        `<a:Cross:1265733965180960849> | Oops! It seems like there are no custom role setups configured yet. Use \`${message.guild.prefix}setup\` to create custom roles.`
                    )
                return message.channel.send({ embeds: [embed] })
            }
            ...
            if (roleIndex === -1) {
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(
                        `<a:Cross:1265733965180960849> | Oops! The role with the name **${roleName}** couldn't be found in my custom role setups. Double-check the name and try again.`
                    )
                return message.channel.send({ embeds: [embed] })
            }
            ...
            if (!data) {
                const embed = new MessageEmbed()
                    ...
                    .setDescription(
                        `<:stolen_emoji:1249318563437871194> | Oops! There's nothing to display for custom role setups.`
                    )
                    .setAuthor({
                        name: message.guild.name,
                        iconURL:
            ...
            if (
                ...
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setTitle(`<a:Cross:1265733965180960849> Role Position Issue`)
                    .setDescription(
